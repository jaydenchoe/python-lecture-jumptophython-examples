"""
================================================================================
7단계: Gemini 봇 + 파일 검색(RAG) + 이미지 생성 구조도
================================================================================

이 코드는 "파일 검색(RAG)"과 "이미지 생성" 기능이 통합된 챗봇입니다.
사용자가 파일을 업로드하면 Gemini가 내용을 분석하고, 대화 중 언제든 관련 이미지를 생성할 수 있습니다.
...
|                                                                              |
|  5. 답변 출력 (스트리밍) + [이미지 생성 버튼] 표시                           |
|     - "🎨 이 내용만 그리기" (현재 답변 기준)                                 |
|     - "🎨 전체 맥락 그리기" (전체 대화 기준)                                 |
|                                                                              |
|  6. 이미지 생성 버튼 클릭 시:                                                |
|     a. 프롬프트 생성 (Flash 모델): "교수님 화이트보드 스타일로 묘사해줘"     |
|     b. 이미지 생성 (Flash/Pro 모델): "Create an image of..."                 |
|     c. 결과 이미지를 대화 기록에 삽입 및 표시                                |
|                                                                              |
+------------------------------------------------------------------------------+
      |
      | 7. 요청 (Request + File Context)
      v
[Google Gemini AI 서버]
      |
      | 8. 파일 검색 및 답변 생성 (RAG) / 이미지 생성
      |
      | 9. 응답 (Text Stream / Image Data)
      v
[Streamlit 앱]
      |
      | 10. 화면 표시
